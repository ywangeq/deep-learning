...
class AdditiveGaussianNOiseAutoencoder(object):
    ...
    def __init__(self, n_input, n_hidden, transfer_function=tf.nn.softplus,optimizer=tf.train.AdamOptimizer(),
        ...
        self.hidden = self.transfer_function(tf.add(tf.matmul(self.x+scale*tf.random_normal((n_input,))
...
def standaed_scale(X_train, X_test):
...
X_train, X_test = standaed_scale(mnist.train.images, mnist.test.images)
